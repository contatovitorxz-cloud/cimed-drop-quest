  ...
  return (
    <div className="brutal-card brutal-card-hover overflow-hidden">
      <div className="bg-accent dark:bg-accent/10 p-4 border-b-[3px] border-border">
        ...
        <h3 className="font-black text-sm mt-2 text-accent-foreground dark:text-accent uppercase">{drop.title}</h3>
      </div>
      <div className="p-4">
...
export default InfluencerDrops;
